...
<div class="ch-container">
    ...
    <div class="row">
        ...
        <?php echo form_open('admin/edit_menu')?>
        <h3>Edit Menu</h3>
        <input type="text" name="id" value="<?php echo $menu->id?>" hidden=""> 
        <table class="table table-hover">
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-pencil blue"></i></span>
                      <input type="text" class="form-control" name="nama_menu" value="<?php echo $menu->nama_menu?>" placeholder="Nama Menu">  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      ...
                      <input type="text" class="form-control" name="url" value="<?php echo $menu->url?>" placeholder="URL">  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      ...
                      <input type="text" class="form-control" name="simbol" value="<?php echo $menu->simbol?>"  placeholder="Simbol">  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <button type="submit" name="submit" class="button form-group btn-success">Edit dan Simpan Menu</button>
                </td>
            </tr>
        </table>
    </form>
