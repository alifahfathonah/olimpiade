...
<div class="ch-container">
            ...
            <tr>
                <td>
                    ...
                    <div class="input-group col-md-12">
                      ...
                      <input type="number" class="form-control" name="waktu" placeholder="Waktu Pengerjaan (Dalam Menit)">
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <tbody>
        <?php $no=1; foreach ($kelas->result() as $t){?>
        <tr>
            <td><?php echo $no?></td>
            ...
            <td><a href="<?php echo base_url()?>index.php/kelas/hapus_kelas/<?php echo $t->id?>" class="label label-danger">Hapus</a></td>
        </tr>
        <?php $no++;}?>
    </tbody>
    </table>
