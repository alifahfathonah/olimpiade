...
<div class="ch-container">
    ...
    <div class="row">
        ...
        <?php echo form_open_multipart('soal/edit_soal_ganda')?>
        <h3>Edit Soal Essay</h3>
        <input type="text" name="id" value="<?php echo $detail_soal_ganda->id?>" hidden=""> 
        <table class="table table-hover">
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      <textarea id="editor1" name="editor1"><?php echo $detail_soal_ganda->isi_soal?></textarea>
                    </div><br>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      ...
                      <input type="text" name="pilihan1" class="form-control" placeholder="Pilihan A" value="<?php echo $detail_soal_ganda->pilihan1?>" required>  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-calendar blue"></i></span>
                      <input type="text" name="pilihan2" class="form-control" placeholder="Pilihan B" value="<?php echo $detail_soal_ganda->pilihan2?>" required>  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-calendar blue"></i></span>
                      <input type="text" name="pilihan3" class="form-control" placeholder="Pilihan C" value="<?php echo $detail_soal_ganda->pilihan3?>" required>  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-calendar blue"></i></span>
                      <input type="text" name="pilihan4" class="form-control" placeholder="Pilihan D" value="<?php echo $detail_soal_ganda->pilihan4?>" required>  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-calendar blue"></i></span>
                      <input type="text" name="pilihan5" class="form-control" placeholder="Pilihan E" value="<?php echo $detail_soal_ganda->pilihan5?>" required>  
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td>
                        <button type="submit" name="submit" class="button form-group btn-primary">Edit dan Simpan Soal Ganda</button>
                </td>
            </tr>
        </table>
    </form>
