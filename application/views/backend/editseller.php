...
<div class="ch-container">
    ...
    <div class="row">
        ...
        <?php echo form_open_multipart('seller/edit_seller')?>
        <h3>Edit Data Seller</h3>
        <input type="text" name="id" value="<?php echo $detail_seller->id?>" hidden=""> 
        <input type="text" name="iduser" value="<?php echo $detail_seller->iduser?>" hidden=""> 
        <table class="table table-hover">
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-user blue"></i></span>
                      <input type="text" class="form-control" name="nama_penjual" value="<?php echo $detail_seller->nama_penjual?>" placeholder="Nama Penjual">  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      ...
                      <input type="text" class="form-control" name="nama_toko" value="<?php echo $detail_seller->nama_toko?>" placeholder="Nama Toko">  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      ...
                      <input type="email" class="form-control" name="email" value="<?php echo $detail_seller->email?>" placeholder="Email" autocomplete="off">  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      ...
                      <input type="password" class="form-control" name="password" value="<?php echo $detail_seller->password?>"  placeholder="Password">  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      ...
                      <input type="text" class="form-control" name="no_hp" value="<?php echo $detail_seller->no_hp?>" placeholder="Telpon/HP">  
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="input-group col-md-12">
                      ...
                      <input type="text" class="form-control" name="alamat" value="<?php echo $detail_seller->alamat?>" placeholder="Alamat Rumah">  
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                        <button type="submit" name="submit" class="button form-group btn-primary">Edit dan Simpan Data Penjual</button>
                </td>
            </tr>
        </table>
    </form>
